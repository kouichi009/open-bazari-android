...
class CommentListActivity : AppCompatActivity() {
    ...
    private val TAG = "CommentListActivity"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Api.MyCommentPosts.observeMyCommentPosts(currentUid, {post, postCount ->

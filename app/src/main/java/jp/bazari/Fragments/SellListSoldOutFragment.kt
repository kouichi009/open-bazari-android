...
class SellListSoldOutFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val view = inflater.inflate(R.layout.fragment_sell_list_sold_out, container, false)
        ...
        view.recyclerView.adapter = PostItemAdapter(postList, mContext, getString(R.string.SellListActivity))
